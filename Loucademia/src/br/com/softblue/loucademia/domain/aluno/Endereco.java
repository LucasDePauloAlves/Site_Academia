...
@Embeddable // vai compartilhar o ID, definido la instanciação la em Aluno
public class Endereco implements Serializable {
	...
	@ManyToOne // muitos endereços para um Estado
	@JoinColumn(name= "ESTADO_ID", nullable = false) // Ele vai ser um ID da tabela Estado
